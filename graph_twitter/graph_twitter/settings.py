"""
Django settings for graph_twitter project.
...
SECRET_KEY = 't5sajyx^cb#*c9rqwgrml(frit6lrn@zuet_mq=^__h#kze*ix'
...
ROOT_URLCONF = 'graph_twitter.urls'
...
WSGI_APPLICATION = 'graph_twitter.wsgi.application'
